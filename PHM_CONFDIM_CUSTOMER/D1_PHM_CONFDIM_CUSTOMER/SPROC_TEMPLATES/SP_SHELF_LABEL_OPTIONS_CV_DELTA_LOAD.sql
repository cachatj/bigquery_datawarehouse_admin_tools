    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SP_SHELF_LABEL_OPTIONS_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for SHELF_LABEL_OPTIONS_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_CUSTOMER.SHELF_LABEL_OPTIONS_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SHELF_LABEL_OPTIONS_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SHELF_LABEL_OPTIONS_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        ...
        TARGET.SHELF_LABEL_OPTIONS_DESC_TXT = SOURCE.SHELF_LABEL_OPTIONS_DESC_TXT,
    ...
    WHEN NOT MATCHED THEN
      ...
      (
        ...
        SOURCE.SHELF_LABEL_OPTIONS_DESC_TXT,
        SOURCE.ROW_ADD_STP,
