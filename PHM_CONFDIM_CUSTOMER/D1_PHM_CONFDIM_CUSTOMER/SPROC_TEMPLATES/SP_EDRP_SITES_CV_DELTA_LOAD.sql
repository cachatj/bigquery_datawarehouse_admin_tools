    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SP_EDRP_SITES_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for EDRP_SITES_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_CUSTOMER.EDRP_SITES_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.EDRP_SITES_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.EDRP_SITES_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYEDRPSPD_YTSD_EDRPSPD_TXT = SOURCE.YYEDRPSPD_YTSD_EDRPSPD_TXT,
        TARGET.YYEDRPSPD_DES_YTSD_EDRPSPD_TXT = SOURCE.YYEDRPSPD_DES_YTSD_EDRPSPD_TXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYEDRPSPD_YTSD_EDRPSPD_TXT,
        SOURCE.YYEDRPSPD_DES_YTSD_EDRPSPD_TXT,
        SOURCE.ROW_ADD_STP,
