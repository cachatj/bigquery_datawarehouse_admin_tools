    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SP_FUEL_SURCHARGE_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for FUEL_SURCHARGE_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_CUSTOMER.FUEL_SURCHARGE_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.FUEL_SURCHARGE_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.FUEL_SURCHARGE_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYFUELCHG_YTSD_FUELCHG_TXT = SOURCE.YYFUELCHG_YTSD_FUELCHG_TXT,
        TARGET.YYFUELCHG_DES_YTSD_FUELCHG_TXT = SOURCE.YYFUELCHG_DES_YTSD_FUELCHG_TXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYFUELCHG_YTSD_FUELCHG_TXT,
        SOURCE.YYFUELCHG_DES_YTSD_FUELCHG_TXT,
        SOURCE.ROW_ADD_STP,
