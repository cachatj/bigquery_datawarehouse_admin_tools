    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SP_SHELF_LABEL_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for SHELF_LABEL_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_CUSTOMER.SHELF_LABEL_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SHELF_LABEL_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SHELF_LABEL_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYSHELFLAB_YTSD_SHELFLABTXT = SOURCE.YYSHELFLAB_YTSD_SHELFLABTXT,
        TARGET.YYSHELFLAB_DES_YTSD_SHELFLABTXT = SOURCE.YYSHELFLAB_DES_YTSD_SHELFLABTXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYSHELFLAB_YTSD_SHELFLABTXT,
        SOURCE.YYSHELFLAB_DES_YTSD_SHELFLABTXT,
        SOURCE.ROW_ADD_STP,
