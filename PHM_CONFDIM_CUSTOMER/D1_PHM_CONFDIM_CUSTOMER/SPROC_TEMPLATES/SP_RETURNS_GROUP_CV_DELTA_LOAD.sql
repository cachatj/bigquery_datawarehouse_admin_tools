    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.SP_RETURNS_GROUP_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for RETURNS_GROUP_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_CUSTOMER.RETURNS_GROUP_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.RETURNS_GROUP_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.RETURNS_GROUP_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYRETGRP_YTSD_RETGRP_TEXT = SOURCE.YYRETGRP_YTSD_RETGRP_TEXT,
        TARGET.YYRETGRP_DES_YTSD_RETGRP_TEXT = SOURCE.YYRETGRP_DES_YTSD_RETGRP_TEXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYRETGRP_YTSD_RETGRP_TEXT,
        SOURCE.YYRETGRP_DES_YTSD_RETGRP_TEXT,
        SOURCE.ROW_ADD_STP,
