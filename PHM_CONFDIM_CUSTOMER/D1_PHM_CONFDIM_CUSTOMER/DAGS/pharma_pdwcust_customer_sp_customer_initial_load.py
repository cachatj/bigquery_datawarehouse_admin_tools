...
# DAG Definition
with DAG(
    'pharma_pdwcust_customer_sp_customer_initial_load',
    default_args=default_args,
    description=f'Process for updating pharma_pdwcust_customer_sp_customer_initial_load',
    ...
    execute_sp_customer_initial_load = BigQueryInsertJobOperator(
        task_id='execute_sp_customer_initial_load',
        configuration={
            'query': {
                'query': f"CALL `{project_id}`.D1_PHM_CONFDIM_CUSTOMER.SP_CUSTOMER_INITIAL_LOAD();",
