CREATE PROCEDURE `PROJECT_ID`.D1_PHM_CONFDIM_CUSTOMER.SP_CUSTOMER_SALES_AREA_RLT_DELTA_LOAD1()
BEGIN
...
INSERT INTO
  ...
  SELECT
    'D1_PHM_CONFDIM_CUSTOMER.SP_CUSTOMER_DELTA_LOAD',
    v_start_time,
    current_datetime(),
    'SUCCESS',
    NULL,
  ...
  ( SELECT 'D1_PHM_CONFDIM_CUSTOMER.SP_CUSTOMER_DELTA_LOAD', current_datetime(), current_datetime(),
