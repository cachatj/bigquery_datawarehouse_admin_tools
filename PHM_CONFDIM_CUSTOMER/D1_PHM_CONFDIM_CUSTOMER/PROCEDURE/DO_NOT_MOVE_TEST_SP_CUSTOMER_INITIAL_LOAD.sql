CREATE PROCEDURE `PROJECT_ID`.D1_PHM_CONFDIM_CUSTOMER.DO_NOT_MOVE_TEST_SP_CUSTOMER_INITIAL_LOAD()
BEGIN
...
AND CUST.D0_START_STP <='2023-10-01 17:09:16 UTC';

-- UPDATE THE EVENT TABLE

UPDATE `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.LAST_TIMESTAMP_CUSTOMER_EV` SET D0_START_STP ='2023-10-01 17:09:16 UTC' WHERE 1=1;
...
INSERT INTO
  ...
  SELECT
    'D1_PHM_CONFDIM_CUSTOMER.SP_CUSTOMER_INITIAL_LOAD',
    v_start_time,
    current_datetime(),
    'SUCCESS',
    NULL,
  ...
  ( SELECT 'D1_PHM_CONFDIM_CUSTOMER.SP_CUSTOMER_INITIAL_LOAD', current_datetime(), current_datetime(),
