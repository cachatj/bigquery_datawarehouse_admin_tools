CREATE VIEW `PROJECT_ID.VW_PHM_CONFDIM_CUSTOMER.INDUSTRY_KEY_CV`(
...
AS SELECT
 BRSCH_T016T     AS     INDST_KEY_ID
,BRTXT_T016T     AS     INDST_KEY_DESC_TXT
,ROW_ADD_STP     AS     ROW_ADD_STP
,ROW_ADD_USER_ID     AS     ROW_ADD_USER_ID
,ROW_UPDATE_STP     AS     ROW_UPDATE_STP
,ROW_UPDATE_USER_ID     AS     ROW_UPDATE_USER_ID
FROM `PROJECT_ID.D1_PHM_CONFDIM_CUSTOMER.INDUSTRY_KEY_CV`;