CREATE TABLE `PROJECT_ID.D2_PHM_CONFDIM_CUSTOMER.CUSTOMER`
(
  ...
  EXGEN_EMBK STRING OPTIONS(description="Calculated DEA License ID;EMBK.EXGEN where EMBK.GEGRU = FD and EMBK.GEART = CUST and EMBK.GENST = C and EMBK.GENNR = T606Z.GENNR and KNA1.KUNNR = T606Z.KUNNR and CURRENT_DATE between EMBK.GANDA and EMBK.GENDA --FD = Federal DEA Regulation; CUST = Customer DEA license; C = Application accepted, license active"),
  GANDA_EMBK DATE OPTIONS(description="Calculated DEA License Valid From Date;Convert EMBK.GANDA to ISO format, default for invalid date = 1900-01-01"),
  ...
  CALC_PHYSCN_STATE_LIC_VALID_FROM_DTE DATE OPTIONS(description="Calculated Physician State License Valid From Date;Convert EMBK.GANDA to ISO format, default for invalid date = 1900-01-01"),
  ...
  CALC_PHYSCN_DME_LIC_VALID_FROM_DTE DATE OPTIONS(description="Calculated Physician DME License Valid From Date;Convert EMBK.GANDA to ISO format, default for invalid date = 1900-01-01"),
