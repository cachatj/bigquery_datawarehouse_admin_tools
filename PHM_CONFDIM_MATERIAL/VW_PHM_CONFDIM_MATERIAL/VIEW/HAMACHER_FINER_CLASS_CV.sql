CREATE VIEW `PROJECT_ID.VW_PHM_CONFDIM_MATERIAL.HAMACHER_FINER_CLASS_CV`(
  HAM_FINER_CLASS_ID OPTIONS(description="Hamacher Finer Class ID"),
...
AS SELECT
 YYFINER_YTMM_FINER_TEXT     AS     HAM_FINER_CLASS_ID
,YYDESC_YTMM_FINER_TEXT     AS     HAM_FINER_CLASS_DESC_TXT
,ROW_ADD_STP     AS     ROW_ADD_STP
,ROW_ADD_USER_ID     AS     ROW_ADD_USER_ID
,ROW_UPDATE_STP     AS     ROW_UPDATE_STP
,ROW_UPDATE_USER_ID     AS     ROW_UPDATE_USER_ID
FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.HAMACHER_FINER_CLASS_CV`;