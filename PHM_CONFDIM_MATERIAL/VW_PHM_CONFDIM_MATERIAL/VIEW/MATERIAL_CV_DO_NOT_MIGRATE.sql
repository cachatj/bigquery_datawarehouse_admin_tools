CREATE VIEW `PROJECT_ID.VW_PHM_CONFDIM_MATERIAL.MATERIAL_CV_DO_NOT_MIGRATE`(
  ...
  SPECIALITY_STRGTH_VALUE_NUM OPTIONS(description="Speciality Strength Value Number"),
  SPECIALITY_STRGTH_UOM_ID OPTIONS(description="Speciality Strength UOM ID"),
  SPECIALITY_VOLUME_VALUE_NUM OPTIONS(description="Speciality Volume Value Number"),
  SPECIALITY_VOLUME_UOM_ID OPTIONS(description="Speciality Volume UOM ID"),
  SPECIALITY_CNCTRT_NMRTR_VALUE_NUM OPTIONS(description="Speciality Concentration Numerator Value Number"),
  SPECIALITY_CNCTRT_NMRTR_UOM_ID OPTIONS(description="Speciality Concentration Numerator UOM ID"),
  SPECIALITY_CNCTRT_DMNTR_VALUE_NUM OPTIONS(description="Speciality Concentration Denominator Value Number"),
  SPECIALITY_CNCTRT_DMNTR_UOM_ID OPTIONS(description="Speciality Concentration Denominator UOM ID"),
  SPECIALITY_BILL_UNIT_VIAL_NUM OPTIONS(description="Speciality Bill Units Vial Number"),
  SPECIALITY_BILL_UNIT_PACK_NUM OPTIONS(description="Speciality Bill Units Package Number"),
  SPECIALITY_TOTAL_ACTIVE_INGRED_DISP_NUM OPTIONS(description="Speciality Total Active Ingredient Disp Number"),
  SPECIALITY_TOTAL_ACTIVE_INGRED_PURCH_NUM OPTIONS(description="Speciality Total Active Ingredient Purchase Number"),
  SPECIALITY_TOTAL_ACTIVE_INGRED_UOM_ID OPTIONS(description="Speciality Total Active Ingredient UOM ID"),
  ...
  CALC_DOCUMENTS_MSNG_ID OPTIONS(description="Calculated Documents Missing ID"),
  CALC_DPLCT_MTRL_REASON_ID OPTIONS(description="Calculated Duplicate Material Reason ID"),
...
,YYSTNGSP_MARA     AS     SPECIALITY_STRGTH_VALUE_NUM
,YYSTNGUOMSP_MARA     AS     SPECIALITY_STRGTH_UOM_ID
,YYVOLSP_MARA     AS     SPECIALITY_VOLUME_VALUE_NUM
,YYVOLUOMSP_MARA     AS     SPECIALITY_VOLUME_UOM_ID
,YYCONCNUM_MARA     AS     SPECIALITY_CNCTRT_NMRTR_VALUE_NUM
,YYCONCNUMUOM_MARA     AS     SPECIALITY_CNCTRT_NMRTR_UOM_ID
,YYCONCDEN_MARA     AS     SPECIALITY_CNCTRT_DMNTR_VALUE_NUM
,YYCONCDENUOM_MARA     AS     SPECIALITY_CNCTRT_DMNTR_UOM_ID
,YYBILLVLSP_MARA     AS     SPECIALITY_BILL_UNIT_VIAL_NUM
,YYBILLPKSP_MARA     AS     SPECIALITY_BILL_UNIT_PACK_NUM
,YYTAIDISP_MARA     AS     SPECIALITY_TOTAL_ACTIVE_INGRED_DISP_NUM
,YYTAIPRCH_MARA     AS     SPECIALITY_TOTAL_ACTIVE_INGRED_PURCH_NUM
,YYTAIUOM_MARA     AS     SPECIALITY_TOTAL_ACTIVE_INGRED_UOM_ID
...
FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.MATERIAL_CV_DO_NOT_MIGRATE`;