CREATE PROCEDURE `PROJECT_ID`.D1_PHM_CONFDIM_MATERIAL.SP_CUSTOMER_PHM_IRM_SNAPSHOT_KOTG753_CV_UP()
BEGIN
/*******************************************************************************************************************************************
...
,KOTG753.D0_SEQ_NUM AS D0_SEQ_NUM
 ...
 ON KOTG753.YYVKORG=TV.VKORG AND TV.SPRAS='E' AND KOTG753.D0_CURR_VRSN_FLG='Y' AND KOTG753.D0_SEQ_NUM='0'
...
ON TMP.YYVKORG_KOTG753 = KOTG753.YYVKORG_KOTG753 AND TMP.YYVTWEG_KOTG753 = KOTG753.YYVTWEG_KOTG753 AND TMP.SPART_KOTG753 = KOTG753.SPART_KOTG753 AND TMP.IRM_CLNUM_KOTG753 = KOTG753.IRM_CLNUM_KOTG753
WHERE
