...
SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.SP_MATERIAL_PRICING_VF_DELTA_LOAD';
...
FROM
`PROJECT_ID.VW_PHM_CONFDIM_MATERIAL.MATERIAL_CV` WHERE CURR_VRSN_FLG = 'Y' ) MAT
ON MAT.MTRL_NUM = PRI.MATNR_A921
