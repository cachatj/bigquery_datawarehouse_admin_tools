CREATE PROCEDURE `PROJECT_ID`.D1_PHM_CONFDIM_MATERIAL.SP_MATERIAL_INITIAL_LOAD()
BEGIN
...
SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.SP_MATERIAL_INITIAL_LOAD';
...
WHERE MAT.D0_CURR_VRSN_FLG = 'Y' AND MAT.D0_START_STP <= v_last_timestamp
);
...
TRUNCATE TABLE `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.MATERIAL_CV`;
...
SELECT DISTINCT
	...
	IFNULL(UOMRE.MSEHL_T006A,'NOT_AVAILABLE') AS CALC_RMBMT_UOM_TXT,		--CALC_RMBMT_UOM_TXT,
	...
	-- IF(AUSP27.ATWRT in ('','NO'),'N','Y') AS CALC_MEDSURG_FLG,
