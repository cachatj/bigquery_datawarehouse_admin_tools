    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SP_FORM_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for FORM_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.FORM_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.FORM_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.FORM_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYFORM_YTMM_FORM_TEXT = SOURCE.YYFORM_YTMM_FORM_TEXT,
        TARGET.YYDESC_YTMM_FORM_TEXT = SOURCE.YYDESC_YTMM_FORM_TEXT,
        TARGET.YYLFORM_YTMM_FORM_TEXT = SOURCE.YYLFORM_YTMM_FORM_TEXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYFORM_YTMM_FORM_TEXT,
        SOURCE.YYDESC_YTMM_FORM_TEXT,
        SOURCE.YYLFORM_YTMM_FORM_TEXT,
        SOURCE.ROW_ADD_STP,
