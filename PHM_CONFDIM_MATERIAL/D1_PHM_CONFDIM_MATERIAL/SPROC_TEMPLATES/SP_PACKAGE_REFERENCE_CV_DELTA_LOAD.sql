    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SP_PACKAGE_REFERENCE_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for PACKAGE_REFERENCE_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.PACKAGE_REFERENCE_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.PACKAGE_REFERENCE_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.PACKAGE_REFERENCE_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYPACREF_YTMM_PACREF_TEXT = SOURCE.YYPACREF_YTMM_PACREF_TEXT,
        TARGET.YYDESC_YTMM_PACREF_TEXT = SOURCE.YYDESC_YTMM_PACREF_TEXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYPACREF_YTMM_PACREF_TEXT,
        SOURCE.YYDESC_YTMM_PACREF_TEXT,
        SOURCE.ROW_ADD_STP,
