    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SP_ORANGE_BOOK_CODE_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for ORANGE_BOOK_CODE_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.ORANGE_BOOK_CODE_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.ORANGE_BOOK_CODE_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.ORANGE_BOOK_CODE_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYOBRAT_YTMM_OBRAT_TEXT = SOURCE.YYOBRAT_YTMM_OBRAT_TEXT,
        TARGET.YYDESC_YTMM_OBRAT_TEXT = SOURCE.YYDESC_YTMM_OBRAT_TEXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYOBRAT_YTMM_OBRAT_TEXT,
        SOURCE.YYDESC_YTMM_OBRAT_TEXT,
        SOURCE.ROW_ADD_STP,
