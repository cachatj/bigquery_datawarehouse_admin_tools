    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SP_DEA_BASE_CODE_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for DEA_BASE_CODE_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.DEA_BASE_CODE_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.DEA_BASE_CODE_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.DEA_BASE_CODE_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYBASE_YTMM_DEA_TEXT = SOURCE.YYBASE_YTMM_DEA_TEXT,
        TARGET.YYDESC_YTMM_DEA_TEXT = SOURCE.YYDESC_YTMM_DEA_TEXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYBASE_YTMM_DEA_TEXT,
        SOURCE.YYDESC_YTMM_DEA_TEXT,
        SOURCE.ROW_ADD_STP,
