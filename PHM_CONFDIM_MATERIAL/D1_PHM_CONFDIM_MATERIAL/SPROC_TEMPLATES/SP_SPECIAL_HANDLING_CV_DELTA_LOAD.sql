    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SP_SPECIAL_HANDLING_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for SPECIAL_HANDLING_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.SPECIAL_HANDLING_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SPECIAL_HANDLING_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SPECIAL_HANDLING_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYSPHD_YTMM_SPECL_TEXT = SOURCE.YYSPHD_YTMM_SPECL_TEXT,
        TARGET.YYDESC_YTMM_SPECL_TEXT = SOURCE.YYDESC_YTMM_SPECL_TEXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYSPHD_YTMM_SPECL_TEXT,
        SOURCE.YYDESC_YTMM_SPECL_TEXT,
        SOURCE.ROW_ADD_STP,
