    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.SP_LIST_1_CHEMICAL_CV_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for LIST_1_CHEMICAL_CV
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFDIM_MATERIAL.LIST_1_CHEMICAL_CV_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.LIST_1_CHEMICAL_CV`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFDIM_MATERIAL.LIST_1_CHEMICAL_CV` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.YYLSTO_YTMM_LIST1_TEXT = SOURCE.YYLSTO_YTMM_LIST1_TEXT,
        TARGET.YYDESC_YTMM_LIST1_TEXT = SOURCE.YYDESC_YTMM_LIST1_TEXT,
    ...
    WHEN NOT MATCHED THEN
      INSERT VALUES
      (
        SOURCE.YYLSTO_YTMM_LIST1_TEXT,
        SOURCE.YYDESC_YTMM_LIST1_TEXT,
        SOURCE.ROW_ADD_STP,
