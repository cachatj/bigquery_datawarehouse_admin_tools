...
# DAG Definition
with DAG(
    'pharma_pdwmtrl_material_sp_last_timestamp_material_ev',
    default_args=default_args,
    description=f'Process for updating pharma_pdwmtrl_material_sp_last_timestamp_material_ev',
    ...
    execute_sp_last_timestamp_material_ev = BigQueryInsertJobOperator(
        task_id='execute_sp_last_timestamp_material_ev',
        configuration={
            'query': {
                'query': f"CALL `{project_id}`.D1_PHM_CONFDIM_MATERIAL.SP_LAST_TIMESTAMP_MATERIAL_EV();",
