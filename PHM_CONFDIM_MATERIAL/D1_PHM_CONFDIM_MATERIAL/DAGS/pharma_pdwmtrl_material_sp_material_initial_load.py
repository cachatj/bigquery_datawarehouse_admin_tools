...
# DAG Definition
with DAG(
    'pharma_pdwmtrl_material_sp_material_initial_load',
    default_args=default_args,
    description=f'Process for updating pharma_pdwmtrl_material_sp_material_initial_load',
    ...
    execute_sp_material_initial_load = BigQueryInsertJobOperator(
        task_id='execute_sp_material_initial_load',
        configuration={
            'query': {
                'query': f"CALL `{project_id}`.D1_PHM_CONFDIM_MATERIAL.SP_MATERIAL_INITIAL_LOAD();",
