...
# DAG Definition
with DAG(
    'pharma_pdwmtrl_material_sp_variable_po_unit_activity_cv_manual',
    default_args=default_args,
    description=f'Process for updating pharma_pdwmtrl_material_sp_variable_po_unit_activity_cv_manual',
    ...
    execute_sp_variable_po_unit_activity_cv_manual = BigQueryInsertJobOperator(
        task_id='execute_sp_variable_po_unit_activity_cv_manual',
        configuration={
            'query': {
                'query': f"CALL `{project_id}`.D1_PHM_CONFDIM_MATERIAL.SP_VARIABLE_PO_UNIT_ACTIVITY_CV_MANUAL();",
