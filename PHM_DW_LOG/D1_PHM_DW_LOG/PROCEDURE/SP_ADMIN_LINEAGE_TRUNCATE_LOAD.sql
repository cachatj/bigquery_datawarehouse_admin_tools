CREATE PROCEDURE `PROJECT_ID`.D1_PHM_DW_LOG.SP_ADMIN_LINEAGE_TRUNCATE_LOAD()
  ...
  `PROJECT_ID`.D1_PHM_DW_LOG.ADMIN_LINEAGE_T  --- Extract the Source to Target Mapping from Stored Proc Runs (Entity Level)
    ...
    SELECT
        ...
        CASE
         ...
         WHEN ReferencedTables.dataset_id LIKE '%D2_%' THEN 4
         WHEN ReferencedTables.dataset_id LIKE '%D4_%' THEN 5
         ELSE 6
         END AS MATCH_RANK,
    ...
    SELECT DISTINCT
        ...
        CASE
         ...
         WHEN temp_tbl_src.SRC_SCHEMA_NAME LIKE '%D2_%' THEN 4
         WHEN temp_tbl_src.SRC_SCHEMA_NAME LIKE '%D4_%' THEN 5
         ELSE 6
         END AS MATCH_RANK,
