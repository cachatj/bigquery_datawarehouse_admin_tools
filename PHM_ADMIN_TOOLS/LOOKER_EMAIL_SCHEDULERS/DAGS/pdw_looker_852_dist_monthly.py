...
if airflow_env == "dev":
    ...
    distListTableName = "PROJECT_ID.VW_PHM_CONFFACT_INVENTORY.EDI_852_DIST_LIST_CV"
    smtp_user = ""
...
with DAG(
    dag_id="pdw_looker_852_dist_monthly",
    default_args=args,
    ...
    create_snow_alert = ServiceNowAlertingOperator(
        ...
        message=f"[PDW]pdw_looker_852_dist_monthly has failed or has failed tasks",
        severity='3',
        source='airflow.cardinalhealth.net',
        additional_details=f"Additional details of failure available at http://airflow.cardinalhealth.net/dags/pdw_looker_852_dist_monthly/grid",
