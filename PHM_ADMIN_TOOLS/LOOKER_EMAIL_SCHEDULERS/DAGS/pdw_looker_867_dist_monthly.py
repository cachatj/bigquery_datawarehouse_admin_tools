...
with DAG(
    dag_id="pdw_looker_867_dist_monthly",
    default_args=args,
    schedule_interval=schedule_interval,
    start_date=pendulum.datetime(2024, 9, 1, tz='US/Eastern'), #days_ago(1),
    catchup=False,
    max_active_runs=1,
    ...
    create_snow_alert = ServiceNowAlertingOperator(
        ...
        message=f"[PDW]pdw_looker_867_dist_monthly has failed or has failed tasks",
        severity='3',
        source='airflow.cardinalhealth.net',
        additional_details=f"Additional details of failure available at http://airflow.cardinalhealth.net/dags/pdw_looker_867_dist_monthly/grid",
