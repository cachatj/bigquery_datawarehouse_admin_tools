...
scripts = [
    "pharma-data-warehouse-edna\PHM_ADMIN_TOOLS\GENERATORS\MODULES\gen_lookml_base_views_enhanced.py",
    "pharma-data-warehouse-edna\PHM_ADMIN_TOOLS\GENERATORS\MODULES\gen_lookml_base_views.py",
    "pharma-data-warehouse-edna\PHM_ADMIN_TOOLS\GENERATORS\MODULES\gen_lookml_refinement_views.py",
    "pharma-data-warehouse-edna\PHM_ADMIN_TOOLS\GENERATORS\MODULES\gen_lookml_refinement_views_gwsa.py"
    ]
