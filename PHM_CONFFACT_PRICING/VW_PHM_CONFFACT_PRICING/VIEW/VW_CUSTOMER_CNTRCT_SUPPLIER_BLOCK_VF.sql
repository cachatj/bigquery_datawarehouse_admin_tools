CREATE VIEW `PROJECT_ID.VW_PHM_CONFFACT_PRICING.VW_CUSTOMER_CNTRCT_SUPPLIER_BLOCK_VF`(
...
AS SELECT
  DISTINCT
KNUMA_AG_A719  AS AGR_NUM_ID
,VKORG_A719 AS SALE_ORG_ID
,VTEXT_TVKOT AS SALE_ORG_DESC_TXT
,VTWEG_A719 AS DIST_CHNL_ID
,VTEXT_TVTWT AS DIST_CHNL_DESC_TXT
,SPART_A719 AS DIV_ID
,VTEXT_TSPAT AS DIV_DESC_TXT
,KUNAG_A719 AS SOLDTO_CUSTOMER_NUM_ID
,IRM_PCNUM_A719 AS CNTRCT_NUM_ID
,LIFNR_A719 AS VENDOR_NUM_ID
,DATAB_A719 AS VRSN_START_DTE
,DATBI_A719 AS VRSN_END_DTE
...
FROM `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_CNTRCT_SUPPLIER_BLOCK_VF`;