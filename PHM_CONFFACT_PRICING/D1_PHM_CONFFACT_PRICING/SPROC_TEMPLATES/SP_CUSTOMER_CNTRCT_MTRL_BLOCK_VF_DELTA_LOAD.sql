    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFFACT_PRICING.SP_CUSTOMER_CNTRCT_MTRL_BLOCK_VF_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for CUSTOMER_CNTRCT_MTRL_BLOCK_VF
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFFACT_PRICING.CUSTOMER_CNTRCT_MTRL_BLOCK_VF_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_CNTRCT_MTRL_BLOCK_VF`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_CNTRCT_MTRL_BLOCK_VF` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.KNUMA_AG_A715 = SOURCE.KNUMA_AG_A715,
        TARGET.VKORG_A715 = SOURCE.VKORG_A715,
        TARGET.VTEXT_TVKOT = SOURCE.VTEXT_TVKOT,
        TARGET.VTWEG_A715 = SOURCE.VTWEG_A715,
        TARGET.VTEXT_TVTWT = SOURCE.VTEXT_TVTWT,
        TARGET.SPART_A715 = SOURCE.SPART_A715,
        TARGET.VTEXT_TSPAT = SOURCE.VTEXT_TSPAT,
        TARGET.KUNAG_A715 = SOURCE.KUNAG_A715,
        TARGET.IRM_PCNUM_A715 = SOURCE.IRM_PCNUM_A715,
        TARGET.MATNR_A715 = SOURCE.MATNR_A715,
        TARGET.DATAB_A715 = SOURCE.DATAB_A715,
        TARGET.DATBI_A715 = SOURCE.DATBI_A715,
