    ...
    CREATE PROCEDURE  `PROJECT_ID.D1_PHM_CONFFACT_PRICING.SP_CUSTOMER_BUY_GRP_MTRL_BLOCK_VF_DELTA_LOAD`()
    BEGIN
    /***********************************************************************************************************************

    Author: <Automatically Written Using Code Generator>
    Creation Date: <Insert Date>
    Sproc Purpose: Delta Loading Merge Sproc for CUSTOMER_BUY_GRP_MTRL_BLOCK_VF
    ...
    ************************************************************************************************************************/
    ...
    SET v_stored_proc_name = 'D1_PHM_CONFFACT_PRICING.CUSTOMER_BUY_GRP_MTRL_BLOCK_VF_DELTA_LOAD';
    SET last_load_timestamp = (SELECT MAX(ROW_ADD_STP) FROM `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_BUY_GRP_MTRL_BLOCK_VF`);


    MERGE INTO  `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_BUY_GRP_MTRL_BLOCK_VF` AS target
     USING 
      (
    ...
    WHEN MATCHED THEN
      UPDATE SET
        TARGET.KNUMA_AG_A716 = SOURCE.KNUMA_AG_A716,
        TARGET.VKORG_A716 = SOURCE.VKORG_A716,
        TARGET.VTEXT_TVKOT = SOURCE.VTEXT_TVKOT,
        TARGET.VTWEG_A716 = SOURCE.VTWEG_A716,
        TARGET.VTEXT_TVTWT = SOURCE.VTEXT_TVTWT,
        TARGET.SPART_A716 = SOURCE.SPART_A716,
        TARGET.VTEXT_TSPAT = SOURCE.VTEXT_TSPAT,
        TARGET.KUNAG_A716 = SOURCE.KUNAG_A716,
        TARGET.IRM_PCBGP_PRI_A716 = SOURCE.IRM_PCBGP_PRI_A716,
        TARGET.MATNR_A716 = SOURCE.MATNR_A716,
        TARGET.DATAB_A716 = SOURCE.DATAB_A716,
        TARGET.DATBI_A716 = SOURCE.DATBI_A716,
