CREATE TABLE `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_BUY_GRP_SUPPLIER_BLOCK_VF`
(
  KNUMA_AG_A717 STRING OPTIONS(description="Agreement Number"),
  VKORG_A717 STRING OPTIONS(description="Sales Organization"),
  ...
  VTWEG_A717 STRING OPTIONS(description="Distribution Channel"),
  ...
  SPART_A717 STRING OPTIONS(description="Division"),
  ...
  KUNAG_A717 STRING OPTIONS(description="Sold To Customer Number"),
  IRM_PCBGP_PRI_A717 STRING OPTIONS(description="Buying Group Number"),
  LIFNR_A717 STRING OPTIONS(description="Vendor Number"),
  DATAB_A717 DATE OPTIONS(description="Version Start Date"),
  DATBI_A717 DATE OPTIONS(description="Version End Date"),
