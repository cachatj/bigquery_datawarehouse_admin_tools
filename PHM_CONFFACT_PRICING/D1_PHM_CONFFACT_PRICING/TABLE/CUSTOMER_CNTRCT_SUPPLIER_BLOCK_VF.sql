CREATE TABLE `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_CNTRCT_SUPPLIER_BLOCK_VF`
(
  KNUMA_AG_A719 STRING OPTIONS(description="Agreement Number"),
  VKORG_A719 STRING OPTIONS(description="Sales Organization"),
  ...
  VTWEG_A719 STRING OPTIONS(description="Distribution Channel"),
  ...
  SPART_A719 STRING OPTIONS(description="Division"),
  ...
  KUNAG_A719 STRING OPTIONS(description="Sold To Customer Number"),
  IRM_PCNUM_A719 STRING OPTIONS(description="Contract Number"),
  LIFNR_A719 STRING OPTIONS(description="Vendor Number"),
  DATAB_A719 DATE OPTIONS(description="Version Start Date"),
  DATBI_A719 DATE OPTIONS(description="Version End Date"),
  ...
  LOEVM_KO_KONP STRING OPTIONS(description="Deletion Indicator Flag; If KONP.LOEVM_KO = X then Y else N where A719.KNUMH = KONP.KNUMH")
);