CREATE TABLE `PROJECT_ID.D1_PHM_CONFFACT_PRICING.CUSTOMER_BUY_GRP_MTRL_BLOCK_VF`
(
  KNUMA_AG_A716 STRING OPTIONS(description="Agreement Number"),
  VKORG_A716 STRING OPTIONS(description="Sales Organization"),
  ...
  VTWEG_A716 STRING OPTIONS(description="Distribution Channel"),
  ...
  SPART_A716 STRING OPTIONS(description="Division"),
  ...
  KUNAG_A716 STRING OPTIONS(description="Sold To Customer Number"),
  IRM_PCBGP_PRI_A716 STRING OPTIONS(description="Buying Group Number"),
  MATNR_A716 STRING OPTIONS(description="Material Number"),
  DATAB_A716 DATE OPTIONS(description="Version Start Date"),
  DATBI_A716 DATE OPTIONS(description="Version End Date"),
  ...
  LOEVM_KO_KONP STRING OPTIONS(description="Deletion Indicator Flag; If KONP.LOEVM_KO = X then Y else N where A716.KNUMH = KONP.KNUMH")
);